...
| --- | --- | --- |
| [`CLAUDE.md`](CLAUDE.md) | The core charter: one Bias, one meta-rule (META-0), nine rules. 2,399 bytes `[executed: wc -c]`, CI-gated at 2,400 (`lint.yml`). | Every session — Claude Code reads it automatically. |
...
Nothing auto-activates. If you never invoke a skill, you run the 2,399-byte core and nothing else.
